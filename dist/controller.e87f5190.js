...
},{}],"src/js/view.js/View.js":[function(require,module,exports) {
"use strict";
  ...
  return _createClass(View, [{
    ...
    value: function update(data) {
      ...
      newElements.forEach(function (NewEl, i) {
        ...
        if (!curEl.isEqualNode(NewEl) && ((_NewEl$firstChild = NewEl.firstChild) === null || _NewEl$firstChild === void 0 ? void 0 : _NewEl$firstChild.nodeValue.trim()) !== '') {
...
},{"../../img/icons.svg":"src/img/icons.svg"}],"src/js/view.js/recipeView.js":[function(require,module,exports) {
"use strict";
...
var RecipeView = /*#__PURE__*/function (_View) {
  function RecipeView() {
    ...
    _defineProperty(_this, "_parentElement", document.querySelector('.recipe'));
    _defineProperty(_this, "_errorMessage", 'We could not find that recipe. Please try another one!');
    _defineProperty(_this, "_message", '');
    return _this;
  }
...
},{"./View.js":"src/js/view.js/View.js","../../img/icons.svg":"src/img/icons.svg"}],"src/js/view.js/searchView.js":[function(require,module,exports) {
"use strict";
...
},{}],"src/js/view.js/previewView.js":[function(require,module,exports) {
"use strict";
...
},{"./View.js":"src/js/view.js/View.js","../../img/icons.svg":"src/img/icons.svg"}],"src/js/view.js/resultsView.js":[function(require,module,exports) {
"use strict";
...
var ResultsView = /*#__PURE__*/function (_View) {
  function ResultsView() {
    ...
    _this = _callSuper(this, ResultsView, [].concat(args));
    _defineProperty(_this, "_parentElement", document.querySelector('.results'));
    _defineProperty(_this, "_errorMessage", 'No recipes found for your query! Please try again ;)');
    _defineProperty(_this, "_message", '');
    return _this;
  }
...
},{"./View.js":"src/js/view.js/View.js","./previewView.js":"src/js/view.js/previewView.js","../../img/icons.svg":"src/img/icons.svg"}],"src/js/view.js/bookmarksView.js":[function(require,module,exports) {
"use strict";
...
},{"./View.js":"src/js/view.js/View.js","./previewView.js":"src/js/view.js/previewView.js","../../img/icons.svg":"src/img/icons.svg"}],"src/js/view.js/paginationView.js":[function(require,module,exports) {
"use strict";
...
var PaginationView = /*#__PURE__*/function (_View) {
  function PaginationView() {
    ...
    _defineProperty(_this, "_parentElement", document.querySelector('.pagination'));
    return _this;
  }
  ...
  return _createClass(PaginationView, [{
    ...
    value: function _generateMarkup() {
      ...
      if (curPage == 1 && numPages > 1) {
        return "<button data-goto=\"".concat(curPage + 1, "\" class=\"btn--inline pagination__btn--next\">\n            <span>Page ").concat(curPage + 1, "</span>\n            <svg class=\"search__icon\">\n              <use href=\"").concat(_icons.default, "#icon-arrow-right\"></use>\n            </svg>\n          </button>");
      }
      // Last page
      if (curPage == numPages && numPages > 1) {
        return "<button data-goto=".concat(curPage - 1, " class=\"btn--inline pagination__btn--prev\">\n            <svg class=\"search__icon\">\n              <use href=\"{Page ").concat(_icons.default, "#icon-arrow-left\"></use>\n            </svg>\n            <span>Page ").concat(curPage - 1, "</span>\n          </button>\n      ");
      }
      // Other page
      if (curPage < numPages) {
...
},{"./View.js":"src/js/view.js/View.js","../../img/icons.svg":"src/img/icons.svg"}],"src/js/controller.js":[function(require,module,exports) {
"use strict";

var model = _interopRequireWildcard(require("./model.js"));
var _recipeView = _interopRequireDefault(require("./view.js/recipeView.js"));
var _icons = _interopRequireDefault(require("../img/icons.svg"));
var _searchView = _interopRequireDefault(require("./view.js/searchView.js"));
var _resultsView = _interopRequireDefault(require("./view.js/resultsView.js"));
var _bookmarksView = _interopRequireDefault(require("./view.js/bookmarksView.js"));
var _View = _interopRequireDefault(require("./view.js/View.js"));
var _paginationView = _interopRequireDefault(require("./view.js/paginationView.js"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
...
init();
},{"./model.js":"src/js/model.js","./view.js/recipeView.js":"src/js/view.js/recipeView.js","../img/icons.svg":"src/img/icons.svg","./view.js/searchView.js":"src/js/view.js/searchView.js","./view.js/resultsView.js":"src/js/view.js/resultsView.js","./view.js/bookmarksView.js":"src/js/view.js/bookmarksView.js","./view.js/View.js":"src/js/view.js/View.js","./view.js/paginationView.js":"src/js/view.js/paginationView.js"}],"C:/Users/Admin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/Admin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/controller.js"], null)
